...
const PaintEditor = function (width, height) {
    ...
    const { buttonRed, buttonGreen, buttonBlue, buttonBrushCircle, buttonBrushTexture } = this.layout
    ...
    this.events = new PaintEvents(this.tex, buttonRed, buttonGreen, buttonBlue, buttonBrushCircle, buttonBrushTexture)
}
